...
const ownerData: TableData[] = [
  {
    ...
    examples:
      "Name, work email address, phone number, company name, billing address.",
    purpose:
      "Account creation, identity verification, service notifications, and direct business communication.",
  },
  {
  ...
  {
    category: "AI Configuration Data",
    examples:
      "Brand Voice & Tone Settings, API keys/credentials for e-commerce platforms (e.g., Shopify), policy documents (Shipping, Returns, FAQ text).",
    purpose:
      "To fine-tune the core AI model's output (RAG system) to match your store's policies, voice, and operational details.",
  },
];
...
const customerData: TableData[] = [
  {
    ...
    examples:
      "Product descriptions, pricing, inventory levels, SKUs, product images, collections, and meta-data.",
    purpose:
      "Core RAG Functionality: To index this data into our vector database (PostgreSQL + pgvector) so the AI can retrieve accurate, real-time information to answer customer questions and generate convincing product explanations.",
  },
  {
...
const usageData: TableData[] = [
  {
    ...
    examples:
      'IP address, browser type, operating system, pages viewed on the Admin Dashboard, time spent on the page, and feature interactions (e.g., clicks on "Enhance with AI").',
    purpose:
      "Monitoring platform health, security, identifying usage trends, and improving the Admin Dashboard user experience.",
  },
  {
    category: "Cookies & Tracking",
    examples: "Standard web cookies and similar tracking technologies.",
    purpose:
      "Authentication (keeping you logged in to the Dashboard), session management, and analytics (details in our separate Cookie Policy).",
  },
];
...
const usagePurposeData: TableData[] = [
  ...
  {
    category: "AI Model Grounding (RAG)",
    examples:
      "To ensure the AI provides accurate, non-hallucinated answers that are strictly grounded in your store's specific E-commerce Product Data and policy documents.",
    purpose: "E-commerce Product Data, AI Configuration Data.",
  },
  {
    category: "Proactive Sales",
    examples:
      "To analyze customer intent and product data to provide personalized, intelligent product recommendations and engage customers effectively.",
    purpose:
      "E-commerce Product Data, Customer Interaction Data, Conversation Logs.",
  },
  {
    category: "Product Improvement & Training",
    examples:
      "We use aggregated, anonymized, or de-identified Conversation Logs to continuously train, fine-tune, and improve the accuracy, safety, and human-like nature of the core AI models (LLMs).",
    purpose:
      "Conversation Logs (anonymized), E-commerce Product Data (aggregated).",
  },
  {
    category: "Billing & Account Management",
    examples:
      "To process payments, manage your subscription level, and enforce service limits (like the Monthly Limit Update you see on the dashboard).",
    purpose:
      "Account & Contact Data, Billing & Payment Data, Service Usage Data.",
  },
  {
    category: "Legal & Security",
    examples:
      "To prevent fraudulent activity, enforce our Terms of Service, and comply with legal obligations, court orders, and government requests.",
    purpose: "All data types.",
  },
];
    ...
    <div className="min-h-screen bg-gray-950 text-gray-400 p-4 sm:p-8">
      <div className="max-w-4xl mx-auto pt-20">
        ...
        <section className="space-y-6">
          ...
          <p className="text-base leading-relaxed">
            We operate as a Business-to-Business (B2B) service, primarily
            processing data on behalf of our e-commerce shop owner customers.
            This Policy addresses two distinct categories of data:
          </p>
          <ul className="list-disc list-inside ml-4 space-y-1">
            ...
            <li>
              ...
              related to your end-customers and products, which we process to
              provide the core AI service.
            </li>
          </ul>
          ...
          >
            <p className="mt-2">
              We collect information from three primary sources: directly from
              the Shop Owner, automatically through service usage, and via
              integration with your e-commerce platform.
            </p>

            <h3 className="text-xl font-bold text-gray-200 mt-6 mb-3">
              1A. Owner Data (Information provided by Shop Owners)
            </h3>
            <p>
              This data is collected directly from you when you register for an
              account or configure the Service.
            </p>
            <DataTable title="Owner Data Categories" data={ownerData} />

            <h3 className="text-xl font-bold text-gray-200 mt-6 mb-3">
              1B. Customer Data (Information we process on your behalf)
            </h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-gray-200 mt-6 mb-3">
              1C. Automatically Collected Data (Usage Data)
            </h3>
            <p>
              When you or your customers use the Service, we automatically
          ...
          <CollapsibleSection
            title="2. How We Use the Information (Purposes of Processing)"
            initialOpen={false}
          >
            <p className="mt-2">
              We use the collected information based on our contractual
              relationship with you and our legitimate interest in providing and
              improving a cutting-edge AI service.
            </p>
          ...
          <CollapsibleSection title="3. Data Sharing and Third-Party Disclosures">
            <div className="space-y-4">
              <p>
                We may share your data (Owner Data) and Customer Data with
                third-party service providers only to the extent necessary to
                operate, maintain, and improve the Service, or when legally
                required.
              </p>
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>
                  ...
                  We ensure that all conversational and product context data
                  sent to these providers is strictly used to generate the
                  response for that specific customer interaction. We have
                  contractual protections in place to prevent the use of your
                  Customer Data or Personal Data for general, foundational model
                  training by the provider.
                </li>
                <li>
                  <strong className="text-white">Data Minimization:</strong> We
                  implement specialized processes to ensure only the necessary,
                  de-identified or anonymized conversational text, combined with
                  your store's proprietary data (product details, policies), is
                  sent for AI processing.
                </li>
              </ul>

              <h4 className="text-lg font-bold text-gray-300">
                3.2. Essential Operational Providers
              </h4>
              <p>
                We use the following third-party categories to manage our
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>
                  ...
                  Providers (e.g., AWS, Google Cloud, Azure) host our backend
                  application, databases, and secure search indexing (for
                  product knowledge) to ensure the service is fast and reliable.
                </li>
                <li>
                  <strong className="text-white">Payment Processing:</strong>{" "}
                  Dedicated payment providers handle all billing and payment
                  card information. We never store raw payment card details
                  ourselves.
                </li>
                <li>
                  <strong className="text-white">
                  ...
                  Services that track Service Usage Data (Section 1C) to help us
                  diagnose issues, optimize platform performance, and understand
                  user behavior.
                </li>
              </ul>
          ...
          <CollapsibleSection title="4. Data Storage, Security, and Retention">
            <div className="space-y-4">
              ...
              <p>
                ...
                designed to protect data against accidental, unlawful, or
                unauthorized loss, access, disclosure, alteration, or
                destruction. Key measures include:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>
                  <strong className="text-white">Encryption:</strong> All data
                  is encrypted both **in transit** (using SSL/TLS) and **at
                  rest** (on disk, including the PostgreSQL database and vector
                  embeddings).
                </li>
                <li>
                  <strong className="text-white">Access Control:</strong> Access
                  to Owner Data and Customer Data is strictly limited to
                  authorized personnel who require access for development,
                  maintenance, and support, and is governed by strong
                  authentication and the principle of least privilege.
                </li>
                <li>
                  <strong className="text-white">
                    Vulnerability Management:
                  </strong>{" "}
                  We regularly monitor our system for security vulnerabilities
              ...
              <p>
                We retain your Owner Data and Customer Data only for as long as
                your account is active and reasonably necessary to provide you
                with the Service.
              </p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>
                  <strong className="text-white">Account Termination:</strong>{" "}
                  If you terminate your account, we will initiate the deletion
                  of your Owner Data and Customer Data within **90 days**.
                </li>
                <li>
                  <strong className="text-white">Exceptions:</strong> We may
                  retain some data (e.g., transactional records, invoices, or
                  de-identified data) for a longer period if necessary for legal
                  compliance (e.g., tax or accounting laws), resolving disputes,
                ...
                <li>
                  ...
                  We may retain **anonymized and aggregated Conversation Logs**
                  indefinitely for continuous AI model training and performance
                  analysis (as detailed in Section 2), provided this data cannot
                  reasonably be linked back to individual customers or
                  transactions.
                </li>
              </ul>
            </div>
          ...
          <CollapsibleSection title="5. Your Rights and Choices">
            <div className="space-y-4">
              ...
              <h4 className="text-lg font-bold text-gray-300">
                5.1. Core Data Rights
              </h4>
              <p>Depending on your jurisdiction, your rights may include:</p>
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>
                  <strong className="text-white">Right of Access:</strong> You
                  can request confirmation of whether we are processing your
                  personal data and obtain a copy of the data we hold about you.
                </li>
                <li>
                  <strong className="text-white">
                    Right to Rectification (Correction):
                  </strong>{" "}
                  You can request that we correct any incomplete or inaccurate
                ...
                <li>
                  ...
                  certain legal obligations (e.g., retaining records for
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>
                  ...
                  deletion or portability requests, you may contact us directly
                  via the details provided in Section 7. We will respond to all
                  valid requests within a reasonable timeframe.
                </li>
              </ul>

              <h4 className="text-lg font-bold text-gray-300">
                5.3. Customer Data Rights (Our Role as Processor)
              </h4>
              <p>
          ...
          <CollapsibleSection title="6. Changes to this Privacy Policy">
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                <li>
                  Sending an email notification to the primary email address
              ...
              <p>
                The updated Privacy Policy will become effective on the date
                stated in the notification. Your continued use of the Service
                after the effective date means you accept the updated Privacy
                Policy. If you do not agree to the changes, you must discontinue
          ...
          <CollapsibleSection title="7. Contact Us">
            <div className="space-y-4">
              <p>
                ...
                Policy, our data practices, or if you wish to exercise any of
                your rights described in Section 5, please contact our dedicated
                Privacy Team:
              </p>
        ...
        <footer className="mt-12 pt-6 border-t border-gray-800 text-center text-xs text-gray-500">
          <p className="italic">
            Disclaimer: This is a policy draft based on your product features
            and is not legal advice. Please consult with a legal professional
            before publishing to ensure full compliance with all applicable
            laws.
          </p>
          <p className="mt-1">
