      ...
      <div className="max-w-4xl mx-auto pt-20">
        <header className="pb-6 border-b border-gray-800 mb-6">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-2 leading-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#A500FF] to-[#FFB300]">
              Cliva Terms of Service
            </span>
          </h1>
          <p className="text-lg text-gray-300">
            Governing your use of the Cliva sales management platform.
          </p>
        ...
        <section className="space-y-6">
          <p className="text-base leading-relaxed">
            ...
            "you"), and **Cliva** ("Cliva," "we," "us," or "our") concerning
            your access to and use of the Cliva e-commerce manager SaaS
            platform ("Service").
          </p>
          ...
          <CollapsibleSection title="2. Service Provision and Scope">
            ...
            <p>
              You acknowledge that Cliva utilizes complex generative models.
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>
                Cliva does not guarantee the accuracy, completeness, or
          ...
          <CollapsibleSection title="5. Intellectual Property (IP)">
            ...
            <h4 className="text-lg font-bold text-gray-300 mt-4">
              5.3. License to Cliva
            </h4>
            <p>
              You grant Cliva a worldwide, non-exclusive, royalty-free,
          ...
          <CollapsibleSection title="6. Termination">
            ...
            <ul className="list-disc list-inside ml-4 space-y-2 mt-3">
              ...
              <li>
                <strong className="text-white">Termination by Cliva:</strong>{" "}
          ...
          <CollapsibleSection title="7. Disclaimers and Limitation of Liability">
            ...
            <p>
              ...
              Cliva EXPRESSLY DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS OR
            ...
            <p>
              IN NO EVENT WILL Cliva OR ITS DIRECTORS, EMPLOYEES, OR AGENTS
