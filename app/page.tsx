...
const Home: React.FC = () => {
  ...
  const handleCtaClick = (planTitle: string) => {
    ...
    if (
      ...
      planTitle.toLowerCase().includes("start free")
    ) {
      planParam = "free";
  ...
  const featureData = [
    {
      ...
      description:
        "Akira instantly handles complex customer questions and objections, ensuring zero friction in the pre-sale process.",
    },
    {
      icon: Tag,
      title: "Proactive Recommendation",
      description:
        "Utilizes real-time behavior data to recommend products, boosting average order value (AOV) without upselling manually.",
    },
    {
      icon: ShoppingCart,
      title: "Cart Recovery",
      description:
        "Automatically engages customers who abandon carts via their preferred channel (email, chat) to complete the purchase.",
    },
    {
      icon: Link,
      title: "Seamless Integration",
      description:
        "Connect Akira to your e-commerce platform and all major messaging channels in minutes, not hours.",
    },
  ];
  ...
  const deepConversionFeatures: FeatureCardProps[] = [
    {
      ...
      description:
        "Flows adapt in real-time based on customer mood, product stock, and current site promotions.",
    },
    {
      icon: Clock,
      title: "AI-Driven Offer Timing",
      description:
        "Akira predicts the optimal micro-moment to deploy discounts or limited-time offers for maximum conversion likelihood.",
    },
    {
      icon: Handshake,
      title: "Adaptive Recommendation Engine",
      description:
        "Recommendations learn from every interaction, ensuring suggested products are always highly relevant to the individual shopper.",
    },
    {
      icon: ShoppingCart,
      title: "Abandoned Cart Recovery",
      description:
        "Personalized, non-intrusive reminders sent directly via the customer's preferred chat channel.",
    },
    {
      icon: Mail,
      title: "Post-Purchase Messaging",
      description:
        "Drive repeat business and loyalty by automatically following up with relevant accessory suggestions and reviews.",
    },
  ];
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-4xl mx-auto">
              Akira moves beyond reactive customer service. It is a proactive,
              learning system designed to empower store owners, giving them a
              scalable sales team that never sleeps and only focuses on the
              bottom line.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            ...
            <div className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-gray-800 transition duration-300 hover:border-[#A500FF] hover:shadow-xl hover:shadow-purple-900/40">
              ...
              <p className="text-gray-400">
                Akira acts as a true sales manager, making autonomous decisions
                to maximize revenue rather than just following fixed, static
                scripts.
              </p>
            </div>
            ...
            <div className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-gray-800 transition duration-300 hover:border-[#FFB300] hover:shadow-xl hover:shadow-orange-900/40">
              ...
              <p className="text-gray-400">
                Every feature is tuned for one goal: boosting your conversion
                rate and increasing your average transaction value, driving
            ...
            <div className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-gray-800 transition duration-300 hover:border-[#A500FF] hover:shadow-xl hover:shadow-purple-900/40">
              ...
              <p className="text-gray-400">
                Go live in minutes. No complex APIs or coding needed—just a
                simple, single-script install for your e-commerce site and
                messaging apps.
              </p>
            </div>
          </div>
