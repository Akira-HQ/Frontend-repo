...
class Particle {
  x: number; y: number; radius: number; velocity: Velocity; opacity: number; hue: number; saturation: number; lightness: number;
...
export const AkiraStarsBackground: React.FC<AkiraStarsBackgroundProps> = ({ density = 200 }) => {
