...
const OverviewProductTable = ({ products, selectedProduct, onSelectedProduct }: ProductTableProps) => {

  if (!products || products.length === 0) {
    return (
      <div className='p-8 bg-[#0f1117] rounded-lg text-center text-gray-500'>
        No products found. Please connect your store or wait for the initial sync.
      </div>
    );
  }
        ...
        return (
          ...
          >
            ...
            <div className="col-span-4 flex flex-col justify-center">
              ...
              <span className='text-xs text-gray-500 font-mono'>SKU: {product.sku || product.id.substring(0, 8)}</span>
            </div>
