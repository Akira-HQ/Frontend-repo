...
import { ACCENT_BLUE, CHART_GRID_COLOR, NEON_ORANGE, NEON_PURPLE, TEXT_GRAY } from '@/types';
  ...
  return (
    <div className='py-4 px-2 w-full h-full text-white pt-10 ml-6'>
      ...
      <p className='text-gray-400 mb-8 max-w-2xl'>
        Review the impact of the AI sales manager on your core business metrics, user behavior, and revenue trends.
      </p>
