...
export default function Notify({
  ...
  return (
    <div
      className={`transition-opacity mr-[6px] flex flex-col border border-gray-200 bg-[#020509] rounded-lg shadow-xl p-2 -ml-2 duration-500 ease-out ${isExisting ? "animate-fade-out" : "animate-fade-in"}`}
    >
      <div
        className={`${isExisting ? "animate-fade-out" : "animate-fade-in"} duration-300 transition-all`}
      >
              ...
              <div className="mt-2">
                <div className="w-full bg-white rounded-full h-2">
                  <div
                    ...
                    style={{ width: `${notification?.data.progress.value}` }}
                  ></div>
                </div>
              </div>
            )}
